...
# 定义路径参数
SRC_ROOT="/inspire/hdd/global_user/konghanlin-253108540238/datasets/dzb/merged_all" #源数据根目录路径
DST_ROOT=$SRC_ROOT
FINAL_ROOT="/inspire/hdd/global_user/konghanlin-253108540238/datasets/dzb/lerobot_all" #最终输出根目录路径

rm -r $FINAL_ROOT/data
# mkdir -p $FINAL_ROOT
